...
select m.ImdbId,m.Title ImdbTitle,i.chineseTitle,m.Year publish_year,i.year publish_year_douban,i.pubdates publish_date from movie_basic_info m
...
## 未来更新策略：电影有增加则表更新
insert ignore into movies_publish_date_audited (ImdbId,ImdbTitle,chineseTitle,publish_year,publish_year_douban,publish_date)
